...
.login-btn:hover {
	...
	box-shadow: 0 0 25px #00d4ff, 0 0 60px rgba(0, 210, 255, .6);
}
...
body::before {
	...
	position: absolute;
	inset: 0;
	background-image: linear-gradient(rgba(0, 195, 255, .08) 1px,
		transparent 1px), linear-gradient(90deg, rgba(0, 195, 255, .08) 1px,
		transparent 1px);
...
@
keyframes ringRotate {from { transform:rotate(0deg);
...
=========================================*/
.login-card {
	box-shadow: 0 20px 40px rgba(0, 0, 0, .35), 0 0 35px
		rgba(0, 195, 255, .15);
}
	...
	<div class="login-wrapper">
		...
		<div class="login-card">
			...
			<form action="loginUser" method="post">
				...
				<div class="login-footer">Secure ATM Management System</div>
